...
public class BoardControllerTest {
    ...
    public void getAllNotesTest() throws Exception {
        when(boardService.findNotesByBoardId(anyString())).thenReturn(Collections.singletonList(testNote));
    ...
    public void getNoteTest() throws Exception {
        ...
        this.mockMvc.perform(get(String.format("/board/%s/note/%s", testNote.getBoardId(), testNote.getNoteId())))
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(content().contentType(HAL_JSON_CONTENT_TYPE))
    ...
    public void createNoteTest() throws Exception {
        ...
        when(boardService.findNotesByBoardId(anyString())).thenReturn(Collections.emptyList()); // unique title
