...
import com.epam.dashboard.dto.validation.UniqueNoteTitle.UniqueNoteTitleImpl;
...
@Constraint(validatedBy = UniqueNoteTitleImpl.class)
public @interface UniqueNoteTitle {

  String message() default "{com.epam.dashboard.dto.validation.UniqueNoteTitle.message}";

  Class<?>[] groups() default {};

  Class<? extends Payload>[] payload() default {};

  class UniqueNoteTitleImpl implements ConstraintValidator<UniqueNoteTitle, NoteDto> {
