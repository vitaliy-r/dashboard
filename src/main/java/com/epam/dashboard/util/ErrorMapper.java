...
public class ErrorMapper {
  ...
  public static Error mapException(MongoException e) {
    return new Error(ErrorType.PROCESSING_ERROR_TYPE.name(), ErrorCode.MONGO_ERROR_CODE.name(),
        e.getMessage());
  }

  public static Error mapException(Throwable e) {
    return new Error(ErrorType.FATAL_ERROR_TYPE.name(), ErrorCode.APPLICATION_ERROR_CODE.name(),
        e.getMessage());
  }
